...
import numpy as np
import warnings
# from my_module import streamlit_config
    ...
    def regression():
        ...
        with st.form('Regression'):
            ...
            with col3:
                ...
                style_submit_button()  #type:ignore
        ...
        if button:
            ...
            with open(r"C:\Users\barathy\model.pkl", 'rb') as f:
                model = pickle.load(f)
...
# with st.sidebar:
    # tab =st.selectbox("Predicted Selling Price",options='PREDICT SELLING PRICE')
# tab= st.tabs(['PREDICT SELLING PRICE',])
